...
public class CountDownServiceTest {
   ...
   public void shouldSerializeGetCountDownRuleCorrectly() throws JsonProcessingException {
      ...
      TpLinkCommandWrapper command = new TpLinkCommandWrapper(TpLinkTargets.COUNT_DOWN, new GetCountDownRuleCommand());
   ...
   public void shouldSerializeAddCountDownRuleCorrectly() throws JsonProcessingException {
      ...
      TpLinkCommandWrapper command = new TpLinkCommandWrapper(TpLinkTargets.COUNT_DOWN, new AddCountDownRuleCommand(countDownRule));
      String json = mapper.writeValueAsString(command);
   ...
   public void shouldSerializeEditCountDownRuleCorrectly() throws JsonProcessingException {
      ...
      TpLinkCommandWrapper command = new TpLinkCommandWrapper(TpLinkTargets.COUNT_DOWN, new EditCountDownRuleCommand(countDownRule));
      String json = mapper.writeValueAsString(command);
   ...
   public void shouldSerializeDeleteCountDownRuleCorrectly() throws JsonProcessingException {
      ...
      TpLinkCommandWrapper command = new TpLinkCommandWrapper(TpLinkTargets.COUNT_DOWN, new DeleteCountDownRuleCommand("qwertyuiopasdfghjkl"));
      String json = mapper.writeValueAsString(command);
   ...
   public void shouldSerializeDeleteAllCountDownRulesCorrectly() throws JsonProcessingException {
      ...
      TpLinkCommandWrapper command = new TpLinkCommandWrapper(TpLinkTargets.COUNT_DOWN, new DeleteAllCountDownRuleCommand());
      String json = mapper.writeValueAsString(command);
